...
[F_c, F_p] = american_function(Si0, Sj0, r, T, K, N, coefficient_jianshe, coefficient_zhongguo, UDE);
...
for i = 1:length(K_range)
    K_current = K_range(i);
        ...
        [call_prices_K(i), put_prices_K(i)] = american_function(Si0, Sj0, r, T, K_current, N, coefficient_jianshe, coefficient_zhongguo, UDE);
end
...
for i = 1:length(T_range)
    ...
    [call_prices_T(i), put_prices_T(i)] = american_function(Si0, Sj0, r, T_current, K, N, coefficient_jianshe, coefficient_zhongguo, UDE);
end
...
for i = 1:length(r_range)
    ...
    [call_prices_r(i), put_prices_r(i)] = american_function(Si0, Sj0, r_current, T, K, N, coefficient_jianshe, coefficient_zhongguo, UDE);
